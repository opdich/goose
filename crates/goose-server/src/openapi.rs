...
#[openapi(
    paths(
        ...
        super::routes::notes::create_note,
        super::routes::notes::list_notes,
        super::routes::notes::get_note,
        super::routes::notes::update_note,
        super::routes::notes::delete_note,
    ...
    components(schemas(
        ...
        super::routes::notes::CreateNoteRequest,
        super::routes::notes::CreateNoteResponse,
        super::routes::notes::ListNotesResponse,
        super::routes::notes::NoteListItem,
        super::routes::notes::GetNoteResponse,
        super::routes::notes::NoteCitationResponse,
        super::routes::notes::UpdateNoteRequest,
        goose::notes::Note,
        goose::notes::NoteCitation,
        Message,
        MessageContent,
        MessageMetadata,
        TokenState,
